...
def _compile_commands() -> Path:
    ...
    if not path.exists():
        pytest.skip("compile_commands.json is required for AST-backed spec tests")
    return path


def test_load_ifcparse_authored_spec() -> None:
    path = Path(__file__).resolve().parents[1] / "binding_generator" / "specs" / "ifcparse.yml"
    spec = load_authored_spec(path, compile_commands_path=_compile_commands())
...
def test_ifcparse_authored_spec_captures_ownership_and_adapter_rules() -> None:
    ...
    assert calls["ifcopenshell_ifcparse_schema_names"].returns.kind == "string_list"
    ...
    assert calls["ifcopenshell_ifc_file_get_total_inverses_by_id"].kind == "method"
    ...
    assert calls["ifcopenshell_ifc_file_entity_names"].returns.kind == "uint32_list"
    assert calls["ifcopenshell_ifc_file_file_pointer"].returns.kind == "size"
    assert calls["ifcopenshell_ifc_file_get_inverse_indices"].returns.kind == "int32_list"
    ...
    assert calls["ifcopenshell_ifc_schema_declarations"].returns.kind == "handle_list"
    assert calls["ifcopenshell_ifc_schema_declarations"].returns.handle == "declaration"
    assert calls["ifcopenshell_ifc_schema_entities"].returns.kind == "handle_list"
    assert calls["ifcopenshell_ifc_schema_entities"].returns.handle == "entity"
    assert calls["ifcopenshell_ifc_schema_enumeration_types"].returns.kind == "handle_list"
    assert calls["ifcopenshell_ifc_schema_enumeration_types"].returns.handle == "enumeration"
    assert calls["ifcopenshell_ifc_schema_select_types"].returns.kind == "handle_list"
    assert calls["ifcopenshell_ifc_schema_select_types"].returns.handle == "select_type"
    assert calls["ifcopenshell_ifc_schema_type_declarations"].returns.kind == "handle_list"
    ...
    assert calls["ifcopenshell_ifc_type_declaration_argument_types"].returns.kind == "string_list"
    ...
    assert calls["ifcopenshell_ifc_select_type_select_list_names"].returns.kind == "string_list"
    assert calls["ifcopenshell_ifc_select_type_as_select_type"].returns.handle == "select_type"
    assert calls["ifcopenshell_ifc_enumeration_enumeration_items"].returns.kind == "string_list"
    assert calls["ifcopenshell_ifc_enumeration_argument_types"].returns.kind == "string_list"
    ...
    assert calls["ifcopenshell_ifc_entity_argument_types"].returns.kind == "string_list"
    assert calls["ifcopenshell_ifc_entity_all_attributes"].returns.kind == "handle_list"
    assert calls["ifcopenshell_ifc_entity_all_attributes"].returns.handle == "attribute"
    assert calls["ifcopenshell_ifc_entity_all_inverse_attributes"].returns.kind == "handle_list"
    ...
    assert calls["ifcopenshell_ifcparse_instance_list_size"].kind == "method"
    assert calls["ifcopenshell_ifc_instance_id"].kind == "method"
    assert calls["ifcopenshell_ifc_file_schema_name"].kind == "adapter_method"
    ...
    assert calls["ifcopenshell_ifc_instance_set_argument_int32_list"].params[1].type.kind == "int32_list"
    assert calls["ifcopenshell_ifc_instance_set_argument_double_list"].params[1].type.kind == "double_list"
    assert calls["ifcopenshell_ifc_instance_set_argument_string_list"].params[1].type.kind == "string_list"
    assert calls["ifcopenshell_ifc_instance_set_argument_int32_list_list"].params[1].type.kind == "int32_list_list"
    assert calls["ifcopenshell_ifc_instance_set_argument_double_list_list"].params[1].type.kind == "double_list_list"
    ...
    assert calls["ifcopenshell_ifcparse_attribute_value_as_int32_list"].returns.kind == "int32_list"
    assert calls["ifcopenshell_ifcparse_attribute_value_as_double_list"].returns.kind == "double_list"
    assert calls["ifcopenshell_ifcparse_attribute_value_as_int32_list_list"].returns.kind == "int32_list_list"
    assert calls["ifcopenshell_ifcparse_attribute_value_as_double_list_list"].returns.kind == "double_list_list"
    assert calls["ifcopenshell_ifcparse_attribute_value_as_string_list"].returns.kind == "string_list"
