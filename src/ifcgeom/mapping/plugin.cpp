...
extern "C" void emscripten_register_mapping_plugin(ifcopenshell::geometry::impl::mapping_registry* registry) {
	ifcopenshell::geometry::impl::mapping_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::geometry::impl::mapping_plugin::plugin_metadata()));
}
#endif
