...
extern "C" void emscripten_register_kernel_plugin(ifcopenshell::geometry::kernels::kernel_registry* registry) {
	ifcopenshell::geometry::kernels::passthrough_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::geometry::kernels::passthrough_plugin::plugin_metadata()));
}
#endif
