...
extern "C" void emscripten_register_tree_plugin(ifcopenshell::geometry::trees::tree_registry* registry) {
	ifcopenshell::geometry::trees::opencascade_trianglebvh_tree_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::geometry::trees::opencascade_trianglebvh_tree_plugin::plugin_metadata()));
}
#endif
