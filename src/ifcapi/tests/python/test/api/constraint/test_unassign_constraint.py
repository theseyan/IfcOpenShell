...
class TestUnassignConstraint(test.bootstrap.IFC4):
    def test_unassigning_a_constraint(self):
        ...
        assert ifcopenshell.util.constraint.get_constrained_elements(constraint) == set()
    ...
    def test_updating_the_rel_when_a_reference_is_removed_with_multiple_elements(self):
        constraint = ifcopenshell.api.constraint.add_objective(self.file)
