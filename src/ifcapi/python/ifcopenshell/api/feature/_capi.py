...
_BOUND = False
_BIND_NAMES = (
    "ifcopenshell_ifcapi_feature_add_feature",
    "ifcopenshell_ifcapi_feature_add_filling",
    "ifcopenshell_ifcapi_feature_remove_feature",
    "ifcopenshell_ifcapi_feature_remove_filling",
