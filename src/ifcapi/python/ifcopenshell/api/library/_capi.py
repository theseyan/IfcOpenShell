...
_BOUND = False
_BIND_NAMES = (
    "ifcopenshell_ifcapi_library_add_library",
    "ifcopenshell_ifcapi_library_add_reference",
    "ifcopenshell_ifcapi_library_assign_reference",
    "ifcopenshell_ifcapi_library_remove_library",
    "ifcopenshell_ifcapi_library_remove_reference",
    "ifcopenshell_ifcapi_library_unassign_reference",
