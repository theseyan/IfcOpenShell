        ...
        try {
            ...
            switch (value.type()) {
                ...
                case IfcUtil::Argument_ENTITY_INSTANCE:
                    result->set_attribute_value(i, static_cast<IfcUtil::IfcBaseClass*>(value)); break;
                ...
                case IfcUtil::Argument_AGGREGATE_OF_ENTITY_INSTANCE:
                    result->set_attribute_value(i, static_cast<aggregate_of_instance::ptr>(value)); break;
                ...
                case IfcUtil::Argument_AGGREGATE_OF_AGGREGATE_OF_ENTITY_INSTANCE:
                    result->set_attribute_value(i, static_cast<aggregate_of_aggregate_of_instance::ptr>(value)); break;
                default:
                    break;
            }
        } catch (...) {
